...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='alps.conf'
CONFIGFOLDER='/root/.alpscore'
COIN_DAEMON='alpsd'
COIN_CLI='alps-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/Alpenschilling/Alpenschilling/releases/download/v70214/alps-linux-v12.3.0-70214.tar.gz'
